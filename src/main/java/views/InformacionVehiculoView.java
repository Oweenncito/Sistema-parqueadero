...
public class InformacionVehiculoView extends javax.swing.JFrame {
    ...
    @Autowired
    public InformacionVehiculoView(EspacioParqueadero espacio, Vehiculo vehiculo) {
    ...
    private void mostrarInformacionVehiculo() {
         ...
         System.out.println(espacio.getVehiculo().getHoraEntrada());
